...
var ApeeRouter = /** @class */ (function () {
    function ApeeRouter(options) {
        /** 路由列表 */
        this.routeList = {};
        this.setDefaultRoute((options === null || options === void 0 ? void 0 : options.default) || 'home');
    }
    ApeeRouter.prototype.setDefaultRoute = function (_default) {
        if (typeof _default == 'string')
            return this.defaultRoute = this.set(_default)[0];
        if (Array.isArray(_default))
            return this.defaultRoute = this.set.apply(this, _default)[0];
